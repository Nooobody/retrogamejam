...
#define SPRITES                                 \
    ...
    _SPRITE_DMG(SpriteEnemy5, enemy5)           \
    _SPRITE_DMG(SpriteBullet, bullet)           \
    _SPRITE_DMG(SpriteEnemyBulletLeft, enemybulletball) \
    _SPRITE_DMG(SpriteEnemyBulletRight, enemybulletball) \
    _SPRITE_DMG(SpriteStars, stars)             \
    _SPRITE_DMG(SpriteEnemykys, enemykys)       \
    _SPRITE_DMG(SpritePlayerkys, enemykys)     \
